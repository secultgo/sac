  ...
  <body>
    <div class="container">
        ...
        <div class="mb-3">
            ...
            class="@error('product_code') is-invalid @enderror">
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" 
            class="form-label">Descrição do produto</label>
            <textarea name="product_description"
             class="form-control" 
             id="exampleFormControlTextarea1" 
             rows="3" 
             class="@error('product_description') is-invalid @enderror">{{ $products['product_description'] }}</textarea>
        </div>
